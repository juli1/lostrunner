...
public class Map11 implements MapInterface {

	private int NB_CUBES = 18;
	...
	public Map11()
	{
		...
		for ( int i = 0 ; i < 6 ; i++)
		{
			cubesPositions[i * 2][0] = MAP_WIDTH / 3;
			cubesPositions[i * 2][1] = -MAP_DEPTH + i;
			cubesPositions[i * 2 + 1][0] = (MAP_WIDTH / 3) + 1;
		...
		this.heroPositionZ = -MAP_DEPTH + 1;
